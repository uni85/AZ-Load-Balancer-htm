...
🛠️ Infrastructure Specifications (JSON)
...
The 5-Tuple Hash Observation
During testing, I initially saw only lb-VM2.

The Science: Azure Load Balancer uses a 5-tuple hash (Source IP, Source Port, Destination IP, Destination Port, Protocol) to route traffic. Because my Source IP remained the same, the Load Balancer maintained Session Persistence.

The Resolution: I used Incognito Mode and cleared browser caches to initiate new sessions, successfully triggering the Load Balancer to route traffic to lb-VM1.

Troubleshooting: PowerShell Syntax
During the setup, I encountered a CommandNotFoundException. I identified that I had typed Install WindowsFeature (with a space) instead of the required cmdlet Install-WindowsFeature.

📁 Repository Structure
README.md - Project documentation and analysis.

/infrastructure - Raw JSON resource definitions for the VM, NIC, NSG, and Load Balancer.

/scripts - PowerShell scripts used for IIS configuration.

/images - Proof-of-work screenshots.

Note: This project was completed as part of the Azure Cloud Learning path (2026).
